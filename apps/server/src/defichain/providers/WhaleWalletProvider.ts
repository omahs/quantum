...
export class WhaleWalletProvider {
  ...
  createWallet(network: EnvironmentNetwork = EnvironmentNetwork.MainNet, index: number = 2): WhaleWalletAccount {
    ...
    return this.initJellyfishWallet(provider, network).get(index);
  }
